...
def build_index_record(metadata: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "dual_gate_heatmap_path": metadata.get("dual_gate_heatmap_path"),
        "dual_gate_report_path": metadata.get("dual_gate_report_path"),
        "dual_gate_stats_path": metadata.get("dual_gate_stats_path"),
        "dual_gate_lockin_heatmap_path": metadata.get("dual_gate_lockin_heatmap_path"),
        "dual_gate_lockin_report_path": metadata.get("dual_gate_lockin_report_path"),
        "dual_gate_lockin_stats_path": metadata.get("dual_gate_lockin_stats_path"),
